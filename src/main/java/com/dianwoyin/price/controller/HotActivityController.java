...
public class HotActivityController {
    ...
    @GetMapping("/get-hot-activity-list-by-category-id")
    @ApiOperation("根据类目id获取热门活动列表")
    public BizBaseResponse<HotActivityListResponse> getHotActivityListByCategoryId(@ApiParam("类目id") Integer categoryId) {
